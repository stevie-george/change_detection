...
# stats_1999 <- read.csv('changeSize_stats 99 .csv')
# stats_1998 <- read.csv('changeSize_stats 98 .csv')
# stats_1997 <- read.csv('changeSize_stats 97 .csv')
# stats_1996 <- read.csv('changeSize_stats 96 .csv')
# stats_1995 <- read.csv('changeSize_stats 95 .csv')
# 
...
## plot quartiles
  ggplot(timedf) + geom_line(aes(x = time, y = Q3_change, colour="3rd_Quartile"), size = 1, group = 1) + 
    ...
    scale_colour_discrete(name = "Quartile") + scale_color_viridis(discrete = TRUE, option = "plasma")  + theme_light()
