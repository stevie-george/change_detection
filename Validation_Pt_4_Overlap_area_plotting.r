...
stats_2020 <- read.csv('changeSize_overlap_stats 20 .csv')
stats_2019 <- read.csv('changeSize_overlap_stats 19 .csv')
stats_2018 <- read.csv('changeSize_overlap_stats 18 .csv')
stats_2017 <- read.csv('changeSize_overlap_stats 17 .csv')
stats_2016 <- read.csv('changeSize_overlap_stats 16 .csv')
stats_2015 <- read.csv('changeSize_overlap_stats 15 .csv')
stats_2014 <- read.csv('changeSize_overlap_stats 14 .csv')
stats_2013 <- read.csv('changeSize_overlap_stats 13 .csv')
stats_2012 <- read.csv('changeSize_overlap_stats 12 .csv')
stats_2011 <- read.csv('changeSize_overlap_stats 11 .csv')
stats_2010 <- read.csv('changeSize_overlap_stats 10 .csv')
stats_2009 <- read.csv('changeSize_overlap_stats 09 .csv')
stats_2008 <- read.csv('changeSize_overlap_stats 08 .csv')
stats_2007 <- read.csv('changeSize_overlap_stats 07 .csv')
stats_2006 <- read.csv('changeSize_overlap_stats 06 .csv')
stats_2005 <- read.csv('changeSize_overlap_stats 05 .csv')
stats_2004 <- read.csv('changeSize_overlap_stats 04 .csv')
stats_2003 <- read.csv('changeSize_overlap_stats 03 .csv')
stats_2002 <- read.csv('changeSize_overlap_stats 02 .csv')
stats_2001 <- read.csv('changeSize_overlap_stats 01 .csv')
stats_2000 <- read.csv('changeSize_overlap_stats 00 .csv')
# stats_1999 <- read.csv('changeSize_overlap_stats 99 .csv')
# stats_1998 <- read.csv('changeSize_overlap_stats 98 .csv')
# stats_1997 <- read.csv('changeSize_overlap_stats 97 .csv')
# stats_1996 <- read.csv('changeSize_overlap_stats 96 .csv')
# stats_1995 <- read.csv('changeSize_overlap_stats 95 .csv')
# 
