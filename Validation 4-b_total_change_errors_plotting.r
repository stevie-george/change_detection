...
lines(year, fcp_rasters$V1, type="l", col = "green", lwd = 3) # fcp
...
arrows(2015,fcp_errors2015$loweric - 800,2015,fcp_errors2015$upperic + 800, angle = 90, code = 3, length = 0.1, cex=2, col = "green")
